...
medals_input_filename = '../files/OlympicMedals_2020.csv'

with open(medals_input_filename, encoding='utf-8', newline='') as data, \
     open('python_csv_dictWriter.py', 'w', encoding='utf-8') as output_file:
