...
# Printing Data types of variables in Python using type(), Python is dynamically typed like JS,
# but it is strongly typed
print("Python is a dynamic but strongly typed language")
name = 'Annu'
print('print(type(name)):: ', type(name))
age = 10
...
print(f"a % b = {a % b}")   # Modulo after Integer Division
...
print("Strings Slicing in Python")
slice_num = 6
print(f"parrot[0:6] = {parrot[0:6]}")  # slice string from index 0 upto 5, not including index 6
print(f"parrot[3:5] = {parrot[3:5]}")  # slice string from index 3 upto 4, not including index 5
print(f"parrot[:9] = {parrot[:9]}")  # slice string from index 0 upto 8, not including index 9
# start defaults to beginning of sequence
print(f"parrot[10:] = {parrot[10:]}")  # slice string from index 10 upto end of the sequence
...
print("Strings Slicing in Python with negative slice numbers")
# Strings slicing with negative start and stop numbers  - - string[(+/-)start:(+/-)stop:step]
print(f"parrot[-4:-2] = {parrot[-4:-2]}")  # slice string from backwards from -4 upto -3 not including -2 (Bl)
print(f"parrot[-4:12] = {parrot[-4:12]}")
print(f"parrot[-14:-8] = {parrot[-14:-8]}")

print("================================================================================")

print("Strings Slicing in Python with step")
# Using step in Slicing
print(f"parrot[0:6:2] = {parrot[0:6:2]}")
...
print("Strings Slicing in Python with negative step")
...
print(f"Return last character = {letters[-1:]}")
# Return first character through slice
print(f"Return first character = {letters[:1]}")
...
print("String formatting using f-strings in Python 3.6")
...
print("String formatting using String interpolation (used in Python 2)")
